...
namespace CRM.Persistence.Migrations
{
    ...
    [Migration("20260209194512_CreateAttendeesActivitiesTables")]
    partial class CreateAttendeesActivitiesTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRM.Domain.Entities.Attendee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CRM.Domain.Entities.Attendee", b =>
                {
                    b.HasOne("CRM.Domain.Entities.Activity", "Activity")
                        .WithMany()
                        .HasForeignKey("ActivityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CRM.Domain.Entities.Attendee", null)
                        .WithMany("Attendees")
